...
const SCHEMA = [
  ...
  T("air", "spars", "sparStep", "Continue with a thinner tube near the tips", true, null,
    "Where the section gets too thin for the main tube, the bore steps down and a smaller tube carries on outboard, sliding inside the main one — how Titan Dynamics and the Interceptor run their wing spars. Off = the spar simply stops."),
